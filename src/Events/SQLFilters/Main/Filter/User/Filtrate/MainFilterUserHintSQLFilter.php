...
class MainFilterUserHintSQLFilter extends SQLFilter
{
    ...
    public function addFilterConstraint(ClassMetadata $targetEntity, $targetTableAlias): string
    {
        ...
        if ($targetEntity->getReflectionClass()->name != 'App\Entity\Main\Filter\User\Filtrate\MainFilterUserFiltrateHint'){
            return '';
        }
