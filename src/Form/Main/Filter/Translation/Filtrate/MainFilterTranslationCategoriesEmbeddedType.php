...
namespace App\Form\Main\Filter\Translation\Filtrate;
...
class MainFilterTranslationCategoriesEmbeddedType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => MainFilterTranslationFiltrateCategories::class
        ]);
    }
}