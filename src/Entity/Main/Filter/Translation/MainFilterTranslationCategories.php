...
namespace App\Entity\Main\Filter\Translation;
...
#[ORM\Entity(repositoryClass: MainFilterTranslationCategoriesRepository::class)]
#[ORM\Table(name: 'main_filter_translation_categories')]
...
class MainFilterTranslationCategories
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'mainFilterTranslationCategories', targetEntity: MainFilterTranslationFiltrateCategories::class, cascade:['persist', 'remove'] )]
    ...
    /**
     * @return Collection<int, MainFilterTranslationFiltrateCategories>
     */
    ...
    /**
     * @param MainFilterTranslationFiltrateCategories $filterTranslation
     * @return MainFilterTranslationCategories
     */
    public function addFilterTranslation(MainFilterTranslationFiltrateCategories $filterTranslation): self
    {
        if (!$this->filterTranslation->contains($filterTranslation)) {
            $this->filterTranslation->add($filterTranslation);
            $filterTranslation->setMainFilterTranslationCategories($this);
        }
     ...
     * @return MainFilterTranslationCategories
     */
    public function removeFilterTranslation(MainFilterTranslationFiltrateCategories $filterTranslation): self
    {
        if ($this->filterTranslation->removeElement($filterTranslation)) {
            // set the owning side to null (unless already changed)
            if ($filterTranslation->getMainFilterTranslationCategories() === $this) {
                $filterTranslation->setMainFilterTranslationCategories(null);
            }
        }
