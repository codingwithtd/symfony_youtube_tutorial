...
#[ORM\Entity(repositoryClass: MainFilterUserRoleRepository::class)]
#[ORM\Table(name: 'main_filter_user_role')]
...
class MainFilterUserRole
{
    ...
    #[ORM\OneToMany(mappedBy: 'mainFilterUserRole', targetEntity: MainFilterUserFiltrateRole::class, cascade:['persist', 'remove'] )]
    ...
    /**
     * @return Collection<int, MainFilterUserFiltrateRole>
     */
    ...
    /**
     * @param MainFilterUserFiltrateRole $filterTranslation
     * @return MainFilterUserRole
     */
    public function addFilterTranslation(MainFilterUserFiltrateRole $filterTranslation): self
    {
        if (!$this->filterTranslation->contains($filterTranslation)) {
            $this->filterTranslation->add($filterTranslation);
            $filterTranslation->setMainFilterUserRole($this);
        }
     ...
     * @return MainFilterUserRole
     */
    public function removeFilterTranslation(MainFilterUserFiltrateRole $filterTranslation): self
    {
        if ($this->filterTranslation->removeElement($filterTranslation)) {
            // set the owning side to null (unless already changed)
            if ($filterTranslation->getMainFilterUserRole() === $this) {
                $filterTranslation->setMainFilterUserRole(null);
            }
        }
