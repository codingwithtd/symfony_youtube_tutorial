...
use App\Repository\Main\Filter\User\MainFilterUserHintRepository;
...
#[ORM\Entity(repositoryClass: MainFilterUserHintRepository::class)]
#[ORM\Table(name: 'main_filter_user_hint')]
...
class MainFilterUserHint
{
    ...
    #[ORM\OneToMany(mappedBy: 'mainFilterUserHint', targetEntity: MainFilterUserFiltrateHint::class, cascade:['persist', 'remove'] )]
    ...
    /**
     * @return Collection<int, MainFilterUserFiltrateHint>
     */
    ...
    /**
     * @param MainFilterUserFiltrateHint $filterTranslation
     * @return MainFilterUserHint
     */
    public function addFilterTranslation(MainFilterUserFiltrateHint $filterTranslation): self
    {
        if (!$this->filterTranslation->contains($filterTranslation)) {
            $this->filterTranslation->add($filterTranslation);
            $filterTranslation->setMainFilterUserHint($this);
        }
     ...
     * @return MainFilterUserHint
     */
    public function removeFilterTranslation(MainFilterUserFiltrateHint $filterTranslation): self
    {
        if ($this->filterTranslation->removeElement($filterTranslation)) {
            // set the owning side to null (unless already changed)
            if ($filterTranslation->getMainFilterUserHint() === $this) {
                $filterTranslation->setMainFilterUserHint(null);
            }
        }
