...
namespace App\Entity\Main\Filter\User\Filtrate;

use App\Entity\Main\Filter\User\MainFilterUserModule;
use App\Repository\Main\Filter\User\Filtrate\MainFilterUserFiltrateModuleRepository;
...
#[ORM\Entity(repositoryClass: MainFilterUserFiltrateModuleRepository::class)]
#[ORM\Table(name: 'main_filter_user_filtrate_module')]
#[HasLifecycleCallbacks()]

class MainFilterUserFiltrateModule
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
     ...
     * @return MainFilterUserFiltrateModule
     */
