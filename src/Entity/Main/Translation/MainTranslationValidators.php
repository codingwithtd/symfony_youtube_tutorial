...
#[ORM\Entity(repositoryClass: MainTranslationValidatorsRepository::class)]
#[ORM\Table(name: 'main_translation_validators')]
#[UniqueEntity(fields: 'translationKey', message:"unique-translation-key")]
#[HasLifecycleCallbacks()]

class MainTranslationValidators
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'mainTranslationValidators', targetEntity: MainTranslationFiltrateValidators::class, cascade:['persist', 'remove'] )]
    ...
    /**
     * @return Collection<int, MainTranslationFiltrateValidators>
     */
    ...
    /**
     * @param MainTranslationFiltrateValidators $filterTranslation
     * @return MainTranslationValidators
     */
    public function addFilterTranslation(MainTranslationFiltrateValidators $filterTranslation): self
    {
        if (!$this->filterTranslation->contains($filterTranslation)) {
            $this->filterTranslation->add($filterTranslation);
            $filterTranslation->setMainTranslationValidators($this);
        }
     ...
     * @return MainTranslationValidators
     */
    public function removeFilterTranslation(MainTranslationFiltrateValidators $filterTranslation): self
    {
        if ($this->filterTranslation->removeElement($filterTranslation)) {
            // set the owning side to null (unless already changed)
            if ($filterTranslation->getMainTranslationValidators() === $this) {
                $filterTranslation->setMainTranslationValidators(null);
            }
        }
