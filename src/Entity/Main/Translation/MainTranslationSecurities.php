...
#[ORM\Entity(repositoryClass: MainTranslationSecuritiesRepository::class)]
#[ORM\Table(name: 'main_translation_securities')]
#[UniqueEntity(fields: 'translationKey', message:"unique-translation-key")]
#[HasLifecycleCallbacks()]

class MainTranslationSecurities
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'mainTranslationSecurities', targetEntity: MainTranslationFiltrateSecurities::class, cascade:['persist', 'remove'] )]
    ...
    /**
     * @return Collection<int, MainTranslationFiltrateSecurities>
     */
    ...
    /**
     * @param MainTranslationFiltrateSecurities $filterTranslation
     * @return MainTranslationSecurities
     */
    public function addFilterTranslation(MainTranslationFiltrateSecurities $filterTranslation): self
    {
        if (!$this->filterTranslation->contains($filterTranslation)) {
            $this->filterTranslation->add($filterTranslation);
            $filterTranslation->setMainTranslationSecurities($this);
        }
     ...
     * @return MainTranslationSecurities
     */
    public function removeFilterTranslation(MainTranslationFiltrateSecurities $filterTranslation): self
    {
        if ($this->filterTranslation->removeElement($filterTranslation)) {
            // set the owning side to null (unless already changed)
            if ($filterTranslation->getMainTranslationSecurities() === $this) {
                $filterTranslation->setMainTranslationSecurities(null);
            }
        }
