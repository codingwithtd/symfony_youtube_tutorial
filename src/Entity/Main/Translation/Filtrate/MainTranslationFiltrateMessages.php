...
use App\Repository\Main\Translation\Filtrate\MainTranslationFiltrateMessagesRepository;
...
#[ORM\Entity(repositoryClass: MainTranslationFiltrateMessagesRepository::class)]
#[ORM\Table(name: 'main_translation_filtrate_messages')]
#[HasLifecycleCallbacks()]

class MainTranslationFiltrateMessages
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?MainTranslationMessages $mainTranslationMessages = null;
    ...
    /**
     * @return MainTranslationMessages|null
     */
    public function getMainTranslationMessages(): ?MainTranslationMessages
    {
        return $this->mainTranslationMessages;
    }

    /**
     * @param MainTranslationMessages|null $mainTranslationMessages
     * @return MainTranslationFiltrateMessages
     */
    public function setMainTranslationMessages(?MainTranslationMessages $mainTranslationMessages): self
    {
        $this->mainTranslationMessages = $mainTranslationMessages;
