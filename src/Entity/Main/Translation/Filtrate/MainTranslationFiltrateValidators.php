...
use App\Repository\Main\Translation\Filtrate\MainTranslationFiltrateValidatorsRepository;
...
#[ORM\Entity(repositoryClass: MainTranslationFiltrateValidatorsRepository::class)]
#[ORM\Table(name: 'main_translation_filtrate_validators')]
#[HasLifecycleCallbacks()]

class MainTranslationFiltrateValidators
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    private ?MainTranslationValidators $mainTranslationValidators = null;
    ...
    /**
     * @return MainTranslationValidators|null
     */
    public function getMainTranslationValidators(): ?MainTranslationValidators
    {
        return $this->mainTranslationValidators;
    }

    /**
     * @param MainTranslationValidators|null $mainTranslationValidators
     * @return MainTranslationFiltrateValidators
     */
    public function setMainTranslationValidators(?MainTranslationValidators $mainTranslationValidators): self
    {
        $this->mainTranslationValidators = $mainTranslationValidators;
