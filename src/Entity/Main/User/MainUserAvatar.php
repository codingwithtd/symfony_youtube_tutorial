...
use App\Repository\Main\User\MainUserAvatarRepository;
use DateTimeInterface;
use Doctrine\ORM\Mapping as ORM;
use Doctrine\ORM\Mapping\PrePersist;
use Doctrine\ORM\Mapping\PreUpdate;

#[ORM\Entity(repositoryClass: MainUserAvatarRepository::class)]
#[ORM\Table(name: 'main_user_avatar')]

class MainUserAvatar
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    public function setMainUserAccount(?MainUserAccount $mainUserAccount): self
    {
        ...
        if ($mainUserAccount === null && $this->mainUserAccount !== null) {
            $this->mainUserAccount->setUserAvatar(null);
        }

        // set the owning side of the relation if necessary
        if ($mainUserAccount !== null && $mainUserAccount->getUserAvatar() !== $this) {
            $mainUserAccount->setUserAvatar($this);
        }
