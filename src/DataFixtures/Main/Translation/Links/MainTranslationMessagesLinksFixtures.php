...
namespace App\DataFixtures\Main\Translation\Links;
...
class MainTranslationMessagesLinksFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct(ConvertCSVToArray $convertCSVToArray)
    {
        ...
        $this->filename = 'src/DataFixtures/_data_csv/main/translation/links/app_translation_messages_links.csv';
    }
