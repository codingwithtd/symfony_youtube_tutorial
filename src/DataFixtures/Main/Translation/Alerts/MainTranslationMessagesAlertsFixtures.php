...
namespace App\DataFixtures\Main\Translation\Alerts;
...
class MainTranslationMessagesAlertsFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct(ConvertCSVToArray $convertCSVToArray)
    {
        ...
        $this->filename = 'src/DataFixtures/_data_csv/main/translation/alerts/app_translation_messages_alerts.csv';
    }
