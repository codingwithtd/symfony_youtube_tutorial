...
namespace App\DataFixtures\Main\Translation\Buttons;
...
class MainTranslationMessagesButtonsFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct(ConvertCSVToArray $convertCSVToArray)
    {
        ...
        $this->filename = 'src/DataFixtures/_data_csv/main/translation/buttons/app_translation_messages_buttons.csv';
    }
