...
namespace App\DataFixtures\Main\Translation\Navs;
...
class MainTranslationMessagesNavsFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct(ConvertCSVToArray $convertCSVToArray)
    {
        ...
        $this->filename = 'src/DataFixtures/_data_csv/main/translation/navs/app_translation_messages_navs.csv';
    }
