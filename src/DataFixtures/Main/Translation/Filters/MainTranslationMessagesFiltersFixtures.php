...
namespace App\DataFixtures\Main\Translation\Filters;
...
class MainTranslationMessagesFiltersFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct(ConvertCSVToArray $convertCSVToArray)
    {
        ...
        $this->filename = 'src/DataFixtures/_data_csv/main/translation/filters/app_translation_messages_filters.csv';
    }
