...
namespace App\DataFixtures\Main\Translation\Tabs;
...
class MainTranslationMessagesTabsFixtures extends Fixture implements DependentFixtureInterface, FixtureGroupInterface
{
    ...
    public function __construct(ConvertCSVToArray $convertCSVToArray)
    {
        ...
        $this->filename = 'src/DataFixtures/_data_csv/main/translation/tabs/app_translation_messages_tabs.csv';
    }
